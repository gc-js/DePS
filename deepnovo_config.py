...
# denovo files
denovo_input_spectrum_file = "/sdb/bioinfor0/ge_Deps/data/spectrums.mgf"
denovo_input_feature_file = "/sdb/bioinfor0/ge_Deps/data/features.csv.identified.test.nodup"
